...
const ms = require("ms");
class WencyBot extends Client {
  constructor(options) {
    super(options);
    this.commands = new Collection();
    this.aliases = new Collection();
    this.guildInvıtes = new Map([])
...
//
  ...
  ok = "<a:ok:797229775420391465>"
  no = "<a:no:797229775478980619>"
...
//
  ...
  mongoose.connect("mongodb+srv://passengerxd31:passengerxd31@cluster0.hguhf.mongodb.net/weislopes?retryWrites=true&w=majority", { useNewUrlParser: true, useUnifiedTopology: true })
