...
class luqian extends Command {
    ...
    async run(message, args, perm) {
        ...
        if(!user.roles.cache.has("915324694876520474")) {
            await this.client.yolla(`${user} kişisine <@&915324694876520474>,<@&915324694893326365> rolleri verildi.`, message.author, message.channel)
            user.roles.add("915324694876520474")
			//user.roles.add("")
			user.roles.add("915324694893326365")
