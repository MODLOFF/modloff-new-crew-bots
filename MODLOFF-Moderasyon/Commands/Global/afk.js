...
class AFK extends Command {
    ...
    async run(message, args, data) {
        ...
        if (message.content.includes("@here") || message.content.includes("@everyone") || message.content.includes("<@&694861871475458048>") || message.content.includes("694861871475458048")) return
