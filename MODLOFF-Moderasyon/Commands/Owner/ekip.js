...
class Ekip extends Command {
    ...
    async run(message, args, perm) {
        let embed = new MessageEmbed().setColor("RANDOM").setFooter("Root").setAuthor(message.member.displayName, message.author.avatarURL({ dynamic: true }))
