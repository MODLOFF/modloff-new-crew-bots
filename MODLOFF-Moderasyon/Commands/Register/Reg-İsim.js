...
class İsim extends Command {
  constructor(client) {
      super(client, {
          ...
          usage: "erkeasdqweasd4q5w4e5qwek",
          aliases: ["asldlqweplsapldwqe545"]
      });
  }
...
/*
  ...
  if (onay.size < 1) {
    ...
    this.client.channels.cache.get(Log.Root.Nick).send(new MessageEmbed() .setFooter(`Üyenin ceza puanı `+puan+``+ ` - ` + moment(Date.now()).format("LLL")+"")
