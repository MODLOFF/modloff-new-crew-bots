            ...
            newMember.roles.cache.forEach(async role => {
                if (!oldMember.roles.cache.has(role.id)) {
                    const emed = new Discord.MessageEmbed()
                        ...
                        .setColor("RANDOM")
                        .setDescription(`Kişinin eklenen ve alınan tüm rollerine bakmak için \`!rollog @Root\` komutunu kullanın \n
                        **Rol Eklenen kişi**\n ${hedef} - **${hedef.id}** `)
            ...
            oldMember.roles.cache.forEach(async role => {
                if (!newMember.roles.cache.has(role.id)) {
                    const emeed = new Discord.MessageEmbed()
                        .setAuthor(hedef.tag, hedef.displayAvatarURL({ dynamic: true }))
                        .setColor("RANDOM")
                        .setDescription(`Kişinin alınan ve eklenen tüm rollerine bakmak için \`!rollog @Root\` komutunu kullanın \n
                        **Rolü Alınan kişi** \n${hedef} - **${hedef.id}**`)
